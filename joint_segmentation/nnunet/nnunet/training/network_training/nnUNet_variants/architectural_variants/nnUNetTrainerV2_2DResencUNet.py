...
class nnUNetTrainerV2_2DResencUNet(nnUNetTrainerV2):
...
#         blocks_per_stage_decoder = stage_plans['num_blocks_decoder']
    ...
    def setup_DA_params(self):
        ...
        self.net_num_pool_op_kernel_sizes= [[1, 1],
                                            [2, 2],
                                            [2, 2],
                                            [2, 2],
                                            [2, 2],
        ...
        self.deep_supervision_scales = [[1, 1]] + list(list(i) for i in 1 / np.cumprod(
            np.vstack(self.net_num_pool_op_kernel_sizes[1:]), axis=0))[:-1]
